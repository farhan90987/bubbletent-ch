        ...
        $settings['single'] = array(
            ...
            'fields'                => array(
                ...
                array(
                    ...
                    'label'         => __('API Usage Statistics', 'listeo_core'),
...
<?php
                        ...
                        <div class="listeo-cards-grid">
                            ...
                            if ($taxonomy === 'event_category') {
                                ...
                                if (class_exists('Listeo_Core_Custom_Listing_Types')) {
                                    ...
                                    foreach ($custom_types as $type) {
                                        if ($taxonomy === $type->slug . '_category') {
    ...
    public function display_google_api_stats($field) {
        ...
        <div class="listeo-api-stats-container">
            ...
            <?php if ($day_stats && $day_stats->blocked_calls > 0): ?>
                <div class="notice notice-warning inline">
                    <p>
                        <strong><?php _e('⚠️ Rate Limit Warning:', 'listeo_core'); ?></strong>
                        <?php printf(__('%d API calls were blocked due to rate limiting. Consider increasing your limits if needed.', 'listeo_core'), $day_stats->blocked_calls); ?>
                    </p>
                </div>
            <?php endif; ?>
