        ...
        <div class="listeo-health-section listeo-transient-section">
            ...
            <div class="listeo-transient-box">
                ...
                <div class="listeo-transient-actions" id="transient-cleanup-actions" style="display: none;">
                    ...
                    <div class="listeo-cleanup-descriptions">
                        <strong><?php _e('Clean Expired:', 'listeo_core'); ?></strong> <?php _e('Safely removes old plugin cache data (Recommended)', 'listeo_core'); ?><br>
                        <strong><?php _e('Clean Listeo:', 'listeo_core'); ?></strong> <?php _e('Removes Listeo search & listing cache only', 'listeo_core'); ?><br>
                        <strong><?php _e('Clean All:', 'listeo_core'); ?></strong> <?php _e('Removes all plugin cache data (May slow site temporarily)', 'listeo_core'); ?>
                    </div>
